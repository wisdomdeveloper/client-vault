    ...
    <div className="w-full h-screen overflow-y-hidden flex items-center">
      <div className="p-10 mx-auto max-w-[500px] border border-[var(--border-color)] rounded-[8px]">
        ...
        <div className="mx-auto flex justify-center">
          <button></button>
          <button className="border border-[var(--border-color)] px-8 py-3 text-[length:var(--body-s)] font-[500] hover:bg-white hover:text-black text-[var(--text-primary)] rounded-[4px] mt-8 transition cursor-pointer w-full">
            Sign in
          </button>
        </div>
      </div>
